...
public class Easy extends Scene {
   ...
   public static AudioClip vogel;
   FadeTransition fadeTransition;
   public static int HiScoreE;
	    public Easy(Parent root) throws IOException {
	    	super(root,1920,1800);
	    	 vogel = new AudioClip(new File("src/game/gui/sounds/easy.mpeg").toURI().toString());
	        vogel.setCycleCount(1);
	        vogel.play();
	    	
	         b= new BorderPane();
	        BackgroundSize backgroundSize = new BackgroundSize(1920, 1800, true, true, true, false);
	        BackgroundImage backgroundImage = new BackgroundImage(new Image("game/gui/images/scene4.jpg"), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, backgroundSize);
	        ...
	        exc.setText("Exceptions");
	        exc.setMinSize(300, 270);
	        exc.setTranslateX(90);
	        shop.setTranslateY(20);
		   ...
		   wep.getChildren().addAll(wep1,wep2,wep3);
		   wep.setSpacing(100);
	    ...
	    public void updateMap(){
	    	if (battle.isGameOver()){
	    		if (battle.getScore()>HiScoreE)
    			HiScoreE=battle.getScore();
	    		Hard.hard=false;
	    		fadeTransition.play();
	    		vogel.stop();
